...
* 初回セットアップを行い、`.meaning-map/config.json` を生成する。
...
```text
.meaning-map/area-candidates.json
```

### 4. build_area_tree_prompt.py
...
```text
.meaning-map/prompts/area-tree.md
```
